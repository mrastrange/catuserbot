...
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "**⋟ プルトニウムXのための猫 - ꪑꪗ ᥇꠸ꪶꪶ꠸ ⋞**"
    CAT_IMG = gvarstatus("pmpermit_pic")
...
async def amireallyalive(event):
    ...
    cat_caption += f"**{EMOJI} Nekobot Version :** `{catversion}`\n"
